...
description: >
  ...
  system. Use whenever the user says "component inventory", "list the components", or "what components
  do we need" in a general web project (Next.js VSA projects use next-component-inventory).
---
...
2. `design/design_system.md` - Component patterns available
3. `design/information_architecture.md` - Pages and features
4. `tasks/user_journeys.md` - Critical user flows
