# Component Prop Contracts & JS/JSDoc Conventions

Prop contracts for common components (Button, Input, Card, Modal, Table) plus JSDoc documentation style and backend-integration notes. Written as React/JSDoc — treat the prop lists as framework-neutral contracts and translate to the detected framework.
