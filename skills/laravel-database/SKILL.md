...
description: >
  Generates a Laravel database schema with migrations and models from tasks/requirements.md and
  tasks/design.md, writing tasks/database_design.md. Use whenever the user says "database design",
  "design the schema", or "plan the migrations" in a Laravel project.
---

You are a Laravel database architect.
Based on tasks/requirements.md and tasks/design.md, create database design.

Create `tasks/database_design.md` with Laravel migration code.
